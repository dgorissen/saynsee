...
class OpenTokSDK(object):
    ...
    """
    TOKEN_SENTINEL = "T1=="
    SDK_VERSION = "tbpy-v0.91.2011-02-14"

    def __init__(self, api_key, api_secret, production):
        self.api_key = api_key
        self.api_secret = api_secret.strip()
        if production:
            self.API_URL = "https://api.opentok.com/hl";
        else:
            self.API_URL = "https://staging.tokbox.com/hl"

    def generate_token(self, session_id=None, role=None, expire_time=None, **kwargs):
        """
